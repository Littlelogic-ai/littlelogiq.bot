...
class Bot(BaseBot):
    async def on_start(self, session_metadata: SessionMetadata) -> None:
        print("working")
        await self.highrise.walk_to(Position(17.0 , 0.0 , 26.5 , "FrontRight"))
    ...
    async def on_chat(self, user: User, message: str) -> None:
        ...
        if message.lower().startswith("!tipall ") and user.username == "littlelogiq":
              parts = message.split(" ")
              if len(parts) != 2:
        ...
        if message.lower().startswith("!tipme ") and user.username== "littlelogiq":
                try:
        ...
        if        message.startswith("-floor1") or  message.startswith("F1") or  message.startswith("f1") or message.startswith("!floor1") or message.startswith("-floor 1") or message.startswith("Floor 1") or message.startswith("Floor1") or message.startswith("/floor1") or    message.startswith("floor1") or message.startswith("!1") or                                 message.startswith("floor 1") or message.startswith("!floor 1"):
          await self.highrise.teleport(user.id, Position(12.5 , 0.0 , 9.5))

        if        message.startswith("-floor3") or  message.startswith("f3") or  message.startswith("F3") or message.startswith("!floor3") or message.startswith("-floor 3") or message.startswith("Floor 3") or message.startswith("Floor3") or message.startswith("/floor3") or    message.startswith("floor3") or message.startswith("!3") or                                 message.startswith("floor 3") or message.startswith("!floor 3"):
          await self.highrise.teleport(user.id, Position(14.5 , 10.35 , 16.0))
     
        if        message.startswith("-floor2") or  message.startswith("f2") or        message.startswith("F2") or message.startswith("!floor2") or message.startswith("-floor 2") or message.startswith("Floor 2") or message.startswith("Floor2") or message.startswith("/floor2") or    message.startswith("floor2") or message.startswith("!2") or                                 message.startswith("floor 2") or message.startswith("!floor 2"):
          await self.highrise.teleport(user.id, Position(14.0 , 5.25 , 19.5))

        if        message.startswith("JAIL 1") or  message.startswith("/jail 1") or  message.startswith("/jail1") or message.startswith("j1") or message.startswith("J1") or message.startswith("Jail1") or message.startswith("Jail 1") or message.startswith("jail1") or    message.startswith("jail 1") or message.startswith("!Jail 1") or                                 message.startswith("!jail 1") or message.startswith("!jail1"):
          await self.highrise.teleport(user.id, Position(2.5 , 5.25 , 2.5))

        if        message.startswith("JAIL 2") or  message.startswith("/jail 2") or  message.startswith("/jail2") or message.startswith("j2") or message.startswith("J2") or message.startswith("Jail2") or message.startswith("Jail 2") or message.startswith("jail2") or    message.startswith("jail 2") or message.startswith("!Jail 2") or                                 message.startswith("!jail 2") or message.startswith("!jail2"):
          await self.highrise.teleport(user.id, Position(9.0 , 5.25 , 2.5))
        ...
        if              message.startswith("Fairyfloat All") or                              message.startswith("/emote all fairyfloat") or       message.startswith("!emote all fairyfloat"):
          if user.username == "hyrulean" or user.username == "littlelogiq" or user.username == "_TWISTY_MANGO":
        ...
        if        message.startswith("/tp") or       message.startswith("tp") or      message.startswith("!tp") or      message.startswith("/tele") or          message.startswith("Tp") or          message.startswith("Tele") or  message.startswith("!tele"):
    ...
    async def on_whisper(self, user: User, message: str) -> None:
        ...
        if        message.startswith("!Vip") or  message.startswith("/Vip") or  message.startswith("-Vip") or message.startswith("-vip") or message.startswith("v") or message.startswith("V") or message.startswith("VIP") or message.startswith("/vip") or    message.startswith("vip") or message.startswith("!vip") or                                 message.startswith("Vip") or message.startswith("!V"):
          await self.highrise.teleport(user.id, Position(6.0 , 14.75 , 2.0))

        if        message.startswith("M") or  message.startswith("m") or  message.startswith("/m") or message.startswith("Adm") or message.startswith("mod") or message.startswith("/adm") or message.startswith("/mod") or message.startswith("MOD") or    message.startswith("Mod") or message.startswith("!mod") or                                 message.startswith("!adm") or message.startswith("!M"):
          await self.highrise.teleport(user.id, Position(15.0 , 15.5 , 14.5))
